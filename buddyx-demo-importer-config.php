...
function bdi_import_files() {
	return array(
		array(
			...
			'import_plugins'             => array( 'elementor', 'kirki', 'buddypress', 'woocommerce', 'wbcom-essential', 'groovy-menu' ),
		),
		array(
			...
			'import_widget_file_url'     => BDI_PLUGIN_URL . '/demos/buddyxpro/bb-platform/widgets.json',
			'import_customizer_file_url' => BDI_PLUGIN_URL . '/demos/buddyxpro/bb-platform/customizer.dat',
			'import_redux'               => array(),
			'import_preview_image_url'   => 'https://www.example.com/merlin/preview_import_image1.jpg',
			'import_notice'              => __( 'A special note for this import.', 'buddyx-demo-Importer' ),
			'preview_url'                => 'https://www.example.com/my-demo-1',
